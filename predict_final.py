...
def main():
    ...
    # Classifying the image, used Knowledge section here to help weak code accordingly so matplotlib not used
    ...
    class_names = [cat_to_name[c1] for c1 in top_classes]
